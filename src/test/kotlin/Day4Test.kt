...
private const val INPUT = """vxjtwn vjnxtw sxibvv mmws wjvtxn icawnd rprh
...
class Day4Test : StringSpec() {
    ...
    init {
        "should be valid without duplicates" {
            Day4.part1("aa bb cc dd ee") shouldEqual 1
        }

        "should not be valid with duplicates" {
            Day4.part1("aa bb cc dd aa") shouldEqual 0
        }

        "should be valid when similar" {
            Day4.part1("aa bb cc dd aaa") shouldEqual 1
        }

        "should solve part1" {
            Day4.part1(INPUT) shouldEqual 451
        }

        "should not be valid with anagrams" {
            Day4.part2("abcde xyz ecdab") shouldEqual 0
        }

        "should solve part2" {
            Day4.part2(INPUT) shouldEqual 223
        }
    }
}