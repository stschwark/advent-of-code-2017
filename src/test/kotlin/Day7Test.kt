...
private const val SIMPLE_TREE = """pbga (66)
xhth (57)
ebii (61)
havc (66)
ktlj (57)
...
private const val INPUT = """xcpuy (20)
prxlb (35)
yibbu (160)
...
class Day7Test : StringSpec() {
    ...
    init {
        "should find the top of the tower" {
            Day7.part1(SIMPLE_TREE) shouldEqual "tknk"
        }

        "should solve part 1" {
            Day7.part1(INPUT) shouldEqual "eugwuhl"
        }

        "should correct unbalanced program" {
            Day7.part2(SIMPLE_TREE) shouldEqual 60
        }

        "should solve part 2" {
            Day7.part2(INPUT) shouldEqual 420
        }
    }
