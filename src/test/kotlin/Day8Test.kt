...
private const val INPUT = """q inc -541 if c != 4
s inc -555 if o > -5
px dec -84 if x >= -4
y dec -822 if txk > -1
...
private const val SIMPLE_INSTRUCTIONS = """b inc 5 if a > 1
a inc 1 if b < 5
c dec -10 if a >= 1
c inc -20 if c == 10"""
...
class Day8Test : StringSpec() {
    init {
        "should find largest value after execution" {
            Day8.part1(SIMPLE_INSTRUCTIONS) shouldEqual 1
        }

        "should solve part 1" {
            Day8.part1(INPUT) shouldEqual 7296
        }

        "should find largest value during execution" {
            Day8.part2(SIMPLE_INSTRUCTIONS) shouldEqual 10
        }

        "should solve part 2" {
            Day8.part2(INPUT) shouldEqual 8186
        }
    }
}